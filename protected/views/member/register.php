                ...
                <tr valign="top">
                    <td>
                        <div>
                            ...
                            <?php echo $form->radioButton($model, 'employee_sex', array(
                            'value'=>"m",
                            'uncheckValue'=>null)); ?>ชาย
                            
                            <?php echo $form->radioButton($model, 'employee_sex', array(
                            'value'=>"f",
                            'uncheckValue'=>null)); ?>หญิง
                            <?php echo $form->error($model, 'employee_sex'); ?>
                        </div>
                        <div>
                    ...
                    <td>
                        <?php echo Group::getOptions("Employee[group_id]", $model->group_id); ?>
                    </td>
                </tr>
                <tr>
